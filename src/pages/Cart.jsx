    ...
    <main style={{ maxWidth: '1100px', margin: '0 auto', padding: '40px 20px' }}>
      ...
      <div style={{ display: 'flex', gap: '28px', alignItems: 'flex-start' }}>
              ...
              {cartItems.map((item, index) => (
                <div key={index} style={{
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <p style={{ margin: '0 0 4px 0', fontWeight: 700, color: 'var(--text-main)', fontSize: '15px', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                      {item.title}
                    </p>
                    <span style={{
                      display: 'inline-block', fontSize: '11px', fontWeight: 700,
                      padding: '2px 8px', borderRadius: '4px', color: '#fff',
                      background: item.platform === 'PC' ? '#1a202c' : item.platform === 'PS5' ? '#00439c' : item.platform === 'Xbox' ? '#107c10' : '#e60012',
                    }}>
                      {item.platform}
                    </span>
                  </div>
        ...
        <aside style={{
          ...
          <h3 style={{ margin: '0 0 20px 0', fontSize: '17px', fontWeight: 700, borderBottom: '1px solid var(--border-color)', paddingBottom: '14px' }}>
            Resumen del pedido
          </h3>
          ...
          >
            {isProcessing ? '⏳ Verificando...' : 'Proceder al Pago'}
          </button>
